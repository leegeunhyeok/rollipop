...
```json
{ "type": "bundle_build_started", "id": "<id>" }
```
...
```json
{ "type": "bundle_build_done", "id": "<id>", "totalModules": 1270, "duration": 1523.45 }
```
...
```json
{ "type": "bundle_build_failed", "id": "<id>", "error": "SyntaxError: Unexpected token" }
```
...
```json
{ "type": "watch_change", "id": "<id>", "file": "src/App.tsx" }
```
