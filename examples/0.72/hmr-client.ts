...
/**
 * @see https://github.com/facebook/react-native/blob/0.72-stable/packages/react-native/Libraries/Utilities/HMRClient.js#L41-L54
 */
...
class HMRClient implements HMRClientNativeInterface {
  ...
  private showUnavailableMessageIfNeeded() {
    ...
    if (this.enabled) {
      // 0.72 LoadingView lacks the 'error' type and dismissButton option that 0.84
      // introduced — surface the disconnect via console.warn instead of a banner.
